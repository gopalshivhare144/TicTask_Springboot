...
public class TaskController {
        ...
        public ResponseEntity<ApiResponse<Void>> deleteTask(@PathVariable Long id) {
                ...
                return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("Task deleted successfully"));
        }
        ...
        public ResponseEntity<ApiResponse<TaskResponseDto>> getTask(@PathVariable Long id) {
                ...
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("Task fetched successfully", response));
        }
        ...
        public ResponseEntity<ApiResponse<PagedResponseDto<TaskResponseDto>>> listTasks(
                ...
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("Tasks fetched successfully", response));
        }
        ...
        public ResponseEntity<ApiResponse<List<TaskResponseDto>>> getTasksByDate(
                ...
                List<TaskResponseDto> responseList = tasks.stream().map(taskWebMapper::toResponseDto).toList();
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("Tasks fetched successfully", responseList));
        }
