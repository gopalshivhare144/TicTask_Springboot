...
public class TaskController {
   ...
   // private final UserService userService;
    ...
    public ResponseEntity<ApiResponse<TaskResponse>> create(
        ...
        Task created = taskService.create(new User(1, "test@gmail.com" , "1234565", "User"), req);
    ...
    public ResponseEntity<ApiResponse<Page<TaskResponse>>> list(
        //@AuthenticationPrincipal UserDetails principal,
                                                                Pageable pageable) {
        Page<Task> page = taskService.list(new User(1, "test@gmail.com" , "1234565", "User"), pageable);
    ...
    public ResponseEntity<ApiResponse<TaskResponse>> get(
        ...
        Task t = taskService.get(new User(1, "test@gmail.com" , "1234565", "User"), id);
